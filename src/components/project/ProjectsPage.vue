<template>
  <div class="text-green-800 grid grid-cols-4 gap-8">
    <div class="bg-white shadow-card rounded-md p-4 min-h-60 flex flex-col">
      <header>
        <div class="flex items-center justify-between">
          <div class="rounded px-3 py-1 bg-green-100 text-xs font-medium tracking-wider text-green-800">Finished</div>
          <div class="relative">
            <div>
              <button
                id="options-menu"
        ...
        <div class="text-md font-medium my-2 text-gray-700">Project Endless</div>
      </header>
      <main>
      ...
      <footer class="flex flex-col justify-between mt-auto">
        <div class="flex flex-row items-center justify-between my-2">
          <div
            class="bg-indigo-400 flex items-center justify-center rounded-md shadow-small px-2 py-1 text-md text-white font-medium"
          >
            MR
          </div>
          <button
    ...
    <div class="bg-gray-100 rounded-md p-4 h-60 flex items-center justify-center">
      ...
      >
        <svg
          ...
          stroke-linecap="round"
          stroke-linejoin="round"
          class="feather feather-plus stroke-current w-5 h-5 text-indigo-600 mr-2"
        >
