      ...
      <div v-if="stepList[currentStep].key === 'preview'" :key="currentStep" class="py-2 px-4 space-y-2">
        ...
        <div class="">
          ...
          <div class="flex flex-row space-x-2 mt-2">
            ...
            <div class="flex-auto p-2 text-sm font-medium text-white bg-blue-500 rounded shadow-small">In Progress</div>
...
export default {
  ...
  mounted() {
    if (this.$route.params.projectId !== undefined) {
      ...
      this.projectData.members = objectClone(this.selectedProject.teamMembers);
    }
  },
  methods: {
